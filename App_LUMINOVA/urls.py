...
from .views import (
    ...
    desglose3, compras_crear_oc_desde_insumo_view, compras_crear_oc_view,
...
urlpatterns = [
    ...
    path('compras/orden/crear/desde-insumo/<int:insumo_id>/', compras_crear_oc_desde_insumo_view, name='compras_crear_oc_desde_insumo'),
